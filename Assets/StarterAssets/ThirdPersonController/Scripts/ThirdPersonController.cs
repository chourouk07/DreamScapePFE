...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public float LeftClamp = 45.0f;

        [Tooltip("How far in degrees can you move the camera right")]
        public float RightClamp = 45.0f;
        ...
        public float platformNewSpeed = 1.0f;
        ...
        void SlowDownMovingObjects()
        {
            ...
            foreach (GameObject obj in movingObjects)
            {
                ...
                //float oldSpeed = movingPlatform.platMoveSpeed;
            }
        }
        ...
        void ResetMovingObjects()
        {
            foreach (GameObject obj in movingObjects)
            {
                ...
                if (rb != null)
                {
                    rb.velocity /= TimeDilationFactor;
                }*/
                MovingPlatform movingPlatform = obj.GetComponent<MovingPlatform>();
                movingPlatform.platMoveSpeed /= 0.2f;
            }
        }
